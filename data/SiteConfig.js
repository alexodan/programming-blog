const config = {
  siteTitle: "Casual JS", // Site title.
  siteTitleShort: "Casual JS", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
  siteTitleAlt: "Casual JS", // Alternative site title for SEO.
  siteLogo: "/logos/logo-1024.png", // Logo used for SEO and manifest.
  siteUrl: "https://casualjs.netlify.com", // Domain of your website without pathPrefix.
